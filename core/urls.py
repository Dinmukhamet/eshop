...
urlpatterns = [
    ...
    path('purchase/', views.PurchaseView.as_view(), name='purchases'),
    path('purchase/<int:pk>/', views.PurchaseDetailView.as_view(), name='purchase'),
    ...
    path('footer_media/', views.FooterMediaView.as_view(), name='footer_media'),
